...
from modules.people_controller.views import people
from modules.organization_controller.views import organization
from modules.deals_controller.views import deals
